...
class SemanticSearcher(PaperSource):
    ...
    def _parse_paper(self, item) -> Optional[Paper]:
        ...
        try:
            ...
            # Safely get DOI and ArXiv ID from externalIds
            doi = ""
            arxiv_id = ""
            ...
            # If we have an ArXiv ID but no DOI, synthesize the canonical arXiv DOI
            ...
            # Build extra fields for cross-source dedup
            extra = {}
            if arxiv_id:
